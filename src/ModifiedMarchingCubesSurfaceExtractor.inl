...
namespace PolyVox
{
  //Modified constructors and all methods for MatType
	template<typename VolumeType, typename MatType, typename Controller>
	ModifiedMarchingCubesSurfaceExtractor<VolumeType, MatType, Controller>
  ::ModifiedMarchingCubesSurfaceExtractor(VolumeType* volData, Region region, SurfaceMesh<PositionNormalData<MatType>>* result, Controller controller)
		:m_volData(volData)
	...
	template<typename VolumeType, typename MatType, typename Controller>
	void ModifiedMarchingCubesSurfaceExtractor<VolumeType, MatType, Controller>::execute()
	{		
		m_meshCurrent->clear();
	...
	uint32_t ModifiedMarchingCubesSurfaceExtractor<VolumeType, MatType, Controller>::computeBitmaskForSlice(const Array2DUint8& pPreviousBitmask, Array2DUint8& pCurrentBitmask)
	{
	...
	void ModifiedMarchingCubesSurfaceExtractor<VolumeType, MatType, Controller>::computeBitmaskForCell(const Array2DUint8& pPreviousBitmask, Array2DUint8& pCurrentBitmask, uint32_t uXRegSpace, uint32_t uYRegSpace)
	{
	...
	template<typename VolumeType, typename MatType, typename Controller>
	void ModifiedMarchingCubesSurfaceExtractor<VolumeType, MatType, Controller>::generateVerticesForSlice(const Array2DUint8& pCurrentBitmask,
	...
	template<typename VolumeType, typename MatType, typename Controller>
	void ModifiedMarchingCubesSurfaceExtractor<VolumeType, MatType, Controller>::generateIndicesForSlice(const Array2DUint8& pPreviousBitmask,

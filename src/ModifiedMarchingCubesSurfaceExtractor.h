...
namespace PolyVox
{
  //Modification: added MeshType
	...
	class ModifiedMarchingCubesSurfaceExtractor
	{
	public:
    //Modification: added PositionNormalData 
		ModifiedMarchingCubesSurfaceExtractor(VolumeType* volData, Region region, SurfaceMesh<PositionNormalData<MeshType>>* result, Controller controller = Controller());
...
#include "ModifiedMarchingCubesSurfaceExtractor.inl"
